...
import sys, os
import cv2
import Exp2_Feature_Detection.transformations as transformations
import Exp2_Feature_Detection.features_homework as features
import traceback
...
image = np.array(Image.open('taka.png'))
