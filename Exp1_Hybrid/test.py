...
import Exp1_Hybrid.hybrid as hybrid
...
class TestCrossCorrelation2D(unittest.TestCase):
	...
	'''
        ...
        self.assertTrue(np.allclose(img_dup, self.small_img_grey, atol=1e-08), msg="Failed to return original image under identity cross-correlation")
	...
	'''
        ...
        self.assertTrue(np.allclose(student, solution, atol=1e-08), msg="Incorrect cross-correlation of greyscale image using mean filter")

    def test_mean_filter_rect_grey(self):
        '''
	Tests cross-correlation of grescale image using a rectangular mean filter
	'''
        mean = np.ones((3, 5))
        student = hybrid.cross_correlation_2d(self.small_img_grey, mean)
        solution = cv2.filter2D(self.small_img_grey, -1, mean, borderType=cv2.BORDER_CONSTANT)

        self.assertTrue(np.allclose(student, solution, atol=1e-08), msg="Incorrect cross-correlation of greyscale image using rectangular mean filter")
	...
	'''
        ...
        self.assertTrue(np.allclose(student, solution, atol=1e-08), msg="Incorrect cross-correlation of RGB image using mean filter")
	...
	'''
        ...
        self.assertTrue(np.allclose(student, solution, atol=1e-08), msg="Incorrect cross-correlation of RGB image using random rectangular filter")
	...
	'''
        ...
        self.assertTrue(np.allclose(student, solution, atol=1e-08), msg="Incorrect cross-correlation of greyscale image using filter bigger than image")
...
class TestConvolve2D(unittest.TestCase):
	...
	'''
        ...
        self.assertTrue(np.allclose(img_dup, self.small_img_grey, atol=1e-08), msg="Failed to return original image under identity convolution")
	...
	'''
        ...
        self.assertTrue(np.allclose(student, solution, atol=1e-08), msg="Incorrect result convolving greyscale image using mean filter")
	...
	'''
        ...
        self.assertTrue(np.allclose(student, solution, atol=1e-08), msg="Incorrect result convolving greyscale image using rectangular mean filter")
	...
	'''
        ...
        self.assertTrue(np.allclose(student, solution, atol=1e-08), msg="Incorrect result convolving RGB image using mean filter")
	...
	'''
        ...
        self.assertTrue(np.allclose(student, solution, atol=1e-08), msg="Incorrect result convolving RGB image using random rectangular filter")
	...
	'''
        ...
        self.assertTrue(np.allclose(student, solution, atol=1e-08), msg="Incorrect result convolving greyscale image using filter bigger than image")
